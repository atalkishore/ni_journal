...
async function createToken() {
  try {
    const response = await axios.post(AUTHHOSTS[CURRENT_HOST], AuthTokenRequestData(), {
      headers: AuthHEADERS
    });
...
async function createPayment(data) {
  try {
    const response = await axios.post(HOSTS[CURRENT_HOST] + API.createPayment, data, {
      headers: AuthHEADERS
    });
...
async function createPaymentforSDK(data) {
  try {
    const response = await axios.post(HOSTS[CURRENT_HOST] + API.paymentforSDK, data, {
      headers: AuthHEADERS
    });
    return response.data;
  } catch (error) {
...
async function getPaymentRequestStatus(id) {
  try {
    const response = await axios.get(HOSTS[CURRENT_HOST] + API.paymentStatus + id + '/', {
      headers: AuthHEADERS
    });
    return response.data;
  } catch (error) {
...
async function getPaymentDetails(payment_request_id, payment_id) {
  try {
    const response = await axios.get(HOSTS[CURRENT_HOST] + API.paymentStatus + payment_request_id + '/' + payment_id + '/', {
      headers: AuthHEADERS
    });
    return response.data;
  } catch (error) {
...
async function createRefund(refundRequest) {
  try {
    const response = await axios.post(HOSTS[CURRENT_HOST] + API.refunds + '/', refundRequest, {
      headers: AuthHEADERS
    });
    return response.data;
  } catch (error) {
...
async function getRefundDetails(id) {
  try {
    const response = await axios.get(HOSTS[CURRENT_HOST] + API.refunds + id + '/', {
      headers: AuthHEADERS
    });
    return response.data;
  } catch (error) {
...
function AuthTokenRequestData() {
  return ({
    ...
    'client_id': process.env.PG_IM_CLIENT_ID,
    'client_secret': process.env.PG_IM_CLIENT_SECRET
  });
}
