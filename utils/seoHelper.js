    ...
    switch (page) {
        case PAGE_NAME.REGISTER:
            return {
                ...
                description: 'Sign up for Nifty Invest to access exclusive market insights, investment advice, and financial tools. Join our community to stay updated on the latest trends and make informed investment decisions.',
                keywords: 'NiftyInvest registration, create account, sign up, investment tools, financial resources, market insights, investment recommendations'
            }
        case PAGE_NAME.LOGIN:
            return {
                title: 'Login to NiftyInvest | Access Your Investment Account',
                displayTitle: "Log In",
                description: 'Log in to your NiftyInvest account to access investment tools, financial data, and market insights. Securely manage your investments and stay updated with the latest market trends.',
                keywords: 'NiftyInvest login, sign in, investment account access, financial data, market insights, secure login, investment management'
            }
        case PAGE_NAME.FORGOT_PASS:
            return {
                title: 'Forgot Password | NiftyInvest - Recover Your Account',
                displayTitle: "Forgot your password",
                description: 'Need to reset your password? Use our easy password recovery process to regain access to your NiftyInvest account. Follow the steps to reset your password and continue managing your investments seamlessly.',
                keywords: 'NiftyInvest, forgot password, password recovery, account access, reset password, investment account, account recovery'
            }
        case PAGE_NAME.HOME:
            return {
                title: 'Nifty Invest | Comprehensive Investment Insights and Market Analysis ',
                displayTitle: "Home",
                ...
                keywords: 'nifty investment advice, nifty investment analysis, nifty investment opportunities, nifty put call ratio, how to invest in nifty, pre open market analysis, post market analysis, nifty invest stock news, nifty invest chart, nifty investment insights, nifty investment guide, max pain, option chain, option chain for nifty, nifty invest, put call ratio, historical option chain data, f&o lot size, charts, financial reports, screeners, live stock news, stock technicals'
            }
        case PAGE_NAME.LOT_SIZE:
            return {
                title: 'Lot-Size | Nifty Invest',
                displayTitle: "Lot Size",
                description: 'This page shows the available lot size for stocks traded in options and futures',
                keywords: 'Sgx nifty today, Max Pain, Put Call Ratio,historical Option Chain data, F&O Lot size, Charts, financial reports, screeners, live stock news, stock techinals'
            }
        case PAGE_NAME.SGX_NIFTY:
            return {
                title: 'SGX Nifty Live | SGX Nifty Today | Nifty Invest',
                displayTitle: "SGX Nifty",
                description: 'Check SGX Nifty Future or Sgx nifty index today live price. SGX Nifty is Singapore Stock Exchange Nifty. It is a very popular derivative product of Singapore Exchange as it allows foreign investors to take a position in Indian Market.',
                keywords: 'Sgx nifty live, Sgx nifty today, Sgx nifty index, Sgx nifty now, Sgx nifty real time, sgx nifty update, Sgx nifty share price, Sgx nifty news'
            }
        case PAGE_NAME.MAX_PAIN_TABLE:
            return {
                title: 'Max Pain Analysis for All Stocks | NiftyInvest - Comprehensive Options Data',
                displayTitle: "Max pain Table",
                description: 'Explore max pain points for all stocks on NiftyInvest. Access detailed analysis and charts to understand the price levels where the most financial losses occur for options holders at expiration.',
                keywords: 'max pain, all stocks, NiftyInvest, options data, financial analysis, options trading, stock analysis, market sentiment, price levels'
            }
        case PAGE_NAME.MAX_PAIN:
            return {
                title: 'Max Pain Analysis | NiftyInvest - Options Market Insights',
                displayTitle: "Max pain",
                description: 'Max pain, or the max pain price, refers to the strike price with the highest number of open put and call contracts. It is the price at which the stock would cause the greatest financial losses for the largest number of option holders at expiration. Explore max pain analysis on NiftyInvest to gain insights into market sentiment and options trading.',
                keywords: 'max pain analysis, options market, NiftyInvest, investment decisions, market sentiment, options trading, financial analysis'
            }
        ...
        case PAGE_NAME.PCR_TABLE:
            return {
                title: 'Put-Call Ratio for All Stocks | NiftyInvest - Comprehensive Market Analysis',
                ...
                keywords: 'Put-Call Ratio, all stocks, NiftyInvest, market analysis, options data, PCR, stock analysis, market sentiment, put volume, call volume'
            }
        case PAGE_NAME.PCR:
            return {
                title: 'Put-Call Ratio | NiftyInvest - Market Sentiment and Options Analysis',
                displayTitle: "pull-call-ratio",
                ...
                keywords: 'Put-Call Ratio, PCR, market sentiment, options analysis, NiftyInvest, put volume, call volume, financial analysis, put call ratio nse, put call ratio live'
            }
        ...
        case PAGE_NAME.OPTION_CHAIN:
            return {
                ...
                description: 'Explore the option chain on NiftyInvest to access comprehensive data on call and put options. Analyze strike prices, expiration dates, and trading volumes to make informed decisions in options trading.',
                keywords: 'option chain, NiftyInvest, options data, call options, put options, strike prices, expiration dates, trading volumes, options analysis, option chain nse, option chain live'
            }
        ...
        case PAGE_NAME.INDIAN_NEWS:
            return {
                ...
                keywords: 'Indian news, latest updates, NiftyInvest, market insights, economic news, financial news, investment decisions, market developments, nifty invest stock news'
            }
        case PAGE_NAME.STOCK_NEWS:
            return {
                ...
                keywords: 'stock news, latest updates, NiftyInvest, market insights, stock market trends, corporate announcements, financial developments, investment strategies'
            }
        case PAGE_NAME.PRE_ANALYSIS:
            return {
                title: 'Pre-Open Market Analysis | NiftyInvest - Early Insights and Market Trends',
                displayTitle: "Pre-Open Market Analysis",
                description: 'Get early insights with NiftyInvest’s pre-open market analysis. Explore pre-market trends, potential stock movements, and key factors influencing the market before it opens to make informed trading decisions.',
                keywords: 'pre-open market analysis, NiftyInvest, early market insights, market trends, pre-market analysis, stock movements, trading decisions, financial analysis'
            }
        case PAGE_NAME.POST_ANALYSIS:
            return {
                title: 'Post-Close Market Analysis | NiftyInvest - End-of-Day Insights and Market Trends',
                ...
                keywords: 'post-close market analysis, NiftyInvest, end-of-day insights, market trends, stock movements, financial analysis, daily market review, trading insights'
            }
        case PAGE_NAME.COMPANY_ABOUT:
            return {
                title: 'Company Profiles | NiftyInvest - Comprehensive Business Information',
                displayTitle: "Company",
                description: 'Explore detailed profiles of various companies on NiftyInvest. Get insights into their history, financials, and key executives to make informed investment decisions.',
                keywords: 'NiftyInvest, company profiles, business information, company details, financial insights, executive information, investment research'
            }
        case PAGE_NAME.COMPANY_CHART:
            return {
                title: 'Company Chart | NiftyInvest - Financial Data Visualizations',
                displayTitle: "Company",
                description: 'Access interactive charts on Nifty Invest to analyze market trends and performance. Our detailed charts provide valuable insights for making informed investment decisions.',
                keywords: 'NiftyInvest, company charts, financial data, data visualizations, investment analysis, market trends, company financials'
            }
        case PAGE_NAME.COMPANY_FINANCIALS:
            return {
                title: 'Company Financials | NiftyInvest - In-Depth Financial Analysis',
                displayTitle: "Company",
                description: 'Access detailed financial information for a range of companies on NiftyInvest. Explore comprehensive financial statements, key metrics, and historical performance to guide your investment decisions.',
                keywords: 'NiftyInvest, company charts, financial data, data visualizations, investment analysis, market trends, company financials'
            }
        case PAGE_NAME.COMPANY_TECHNICAL:
            return {
                ...
                displayTitle: "Company",
                description: 'Access comprehensive technical analysis of various companies on NiftyInvest. Explore charts, indicators, and patterns to make informed investment decisions based on market trends and technical data.',
                keywords: 'technical analysis, NiftyInvest, market insights, company analysis, technical indicators, chart patterns, investment decisions, market trends'
            }
        case PAGE_NAME["COMPANY_RELATED-NEWS"]:
            return {
                title: 'Related Company News | NiftyInvest - Latest Updates and Insights',
                displayTitle: "Company",
                description: 'Stay updated with the latest news and updates related to various companies on NiftyInvest. Explore recent developments, market news, and important announcements that could impact your investments.',
                keywords: 'NiftyInvest, company news, latest updates, market news, investment insights, company announcements, financial news'
            }
